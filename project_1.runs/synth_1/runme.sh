...
HD_PWD='D:/FACULTATE/FACULTATE AN 1/Semestrul 2/PSN/proiect_stari/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proiect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proiect.tcl
