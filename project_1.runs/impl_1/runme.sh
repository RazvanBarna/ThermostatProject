...
HD_PWD='D:/FACULTATE/FACULTATE AN 1/Semestrul 2/PSN/proiect_stari/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log proiect.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source proiect.tcl -notrace
